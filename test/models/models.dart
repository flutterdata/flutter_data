...
mixin ShouldntLoadAdapter on RemoteAdapter<Model> {
  @override
  bool shouldLoadRemoteAll(remote, params, headers) {
    return box.isEmpty;
  }
}

class ModelTestRepository = $ModelRepository
    with TestMixin, JSONAPIAdapter, ShouldntLoadAdapter;
